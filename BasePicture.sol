...
contract BasePicture is Ownable {
  ...
  event NewPicture(uint256 id, string name, uint256 _price, uint256 _id);
  ...
  function _createPicture(string memory _name, uint256 _price,  uint256 _id) internal {
    ...
    emit NewPicture(id, _name,  _price, _id);
  }
  ...
  function creatPicture(string memory _name, uint256 _price) internal {
